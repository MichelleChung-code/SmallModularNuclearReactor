...
class ProfitabilityAnalysis:
    def __init__(self, cashflow_df, discount_rate=0.1):
    ...
    def discounted_payback_period(self):
        ...
        annual_cash_flow_df[DISCOUNTED_CASHFLOW] = np_fi.pv(self.annual_discount_rate, pmt=0, nper=annual_cash_flow_df.index,
